...
import edu.illinois.cs.cogcomp.wikifier.train.*;
/**
...
//					out.close();
		...
		if (args[0].equalsIgnoreCase("-trainSvmModelsOnly")) {
//			String pathToProblems="/scratch2/azehady/nlp/Wikifier2013/Wikifier2013/data/WikificationACL2011Data/WikipediaSample_Simple_Test/ProblemsTrain";
//			String rawFilesPath="/scratch2/azehady/nlp/Wikifier2013/Wikifier2013/data/WikificationACL2011Data/WikipediaSample_Simple_Test/RawTextsTrain";
			String pathToProblems="/scratch2/azehady/nlp/Wikifier2013/Wikifier2013/data/WikificationACL2011Data/WikipediaSample/ProblemsTrain";
			String rawFilesPath="/scratch2/azehady/nlp/Wikifier2013/Wikifier2013/data/WikificationACL2011Data/WikipediaSample/RawTextsTrain";
			System.out.println("\n\n********************************************\n\n" +
					"Training and building models from problem training files." +
					"\n\t pathToProblemsTrain="+pathToProblems+
					"\n\t rawFilesPath="+rawFilesPath+
					"\n\n********************************************\n\n");
			
			TrainWikifierSVM.trainRankerLinkerWeights(pathToProblems, rawFilesPath);
		}
	}
